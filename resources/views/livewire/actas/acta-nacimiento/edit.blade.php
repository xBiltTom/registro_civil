<div>
    ...
    <div class="w-full p-6 bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md">
        <form wire:submit="actualizarNacimiento" class="space-y-6">

            <h2 class="text-xl font-semibold text-gray-800 dark:text-white border-b pb-2">Datos del Acta</h2>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    <label for="acta_id" class="block mb-1 font-medium text-gray-700 dark:text-gray-300">N° de Acta</label>
                    <input disabled wire:model="acta_id" type="text" id="acta_id" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white" required>
                    @error('acta_id')
            ...
            <div class="mb-6">
                ...
                <div class="flex">
                    <input
                        wire:model="madre_id"
                        id="madre"
                        x-data="{ madreNombre: '{{ $nombreMadre }}' }"
                        x-model="madreNombre"
                        ...
                        type="text"
                        readonly>
                    <button type="button" x-on:click="$dispatch('open-madre-modal')" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-r-md">
                        Buscar
                    </button>
                </div>
                @error('madre_id')
            ...
            <div class="mb-6">
                ...
                <div class="flex">
                    <input
                        wire:model="padre_id"
                        id="padre"
                        x-data="{ padreNombre: '{{ $nombrePadre }}' }"
                        x-model="padreNombre"
                        ...
                        type="text"
                        readonly>
                    <button type="button" x-on:click="$dispatch('open-padre-modal')" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-r-md">
                        Buscar
                    </button>
                </div>
                @error('padre_id')
            ...
            <div class="mt-6 flex justify-between">
                ...
                <div x-data="{ showAlert: false }">
                    ...
                    <div x-show="showAlert" class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
                        <div class="bg-white rounded-lg shadow-lg p-6 w-96 dark:bg-gray-700">
                            <h2 class="text-lg font-semibold text-gray-800 dark:text-white">¿Estás seguro?</h2>
                            <p class="text-gray-600 dark:text-gray-300 mt-2">No podrás revertir esta acción.</p>
                            <div class="mt-4 flex justify-end space-x-2">
                                <button type="button" @click="showAlert = false" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded-md dark:bg-gray-600 dark:text-white">
                                    Cancelar
                                </button>
