        ...
        {{-- <div class="p-5 text-lg font-semibold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
            <div class="flex justify-between items-center w-full">
                ...
                <div class="relative w-2/3">
                    ...
                    <input wire:model="buscado" type="search" id="buscarActa" class="block w-full p-3 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Buscar por número de acta..." />
                </div>
            </div>
        </div> --}}
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                    ...
                    <td class="px-6 py-4">
                        <span class="px-2 py-1 text-xs font-semibold rounded-full
                            @if($solicitud->estado->id == 2) bg-green-100 text-green-800
                    ...
                    <td class="px-6 py-4 flex justify-center space-x-4 items-center">
                        <a href="{{ route('solicitudes.mostrar', ['id' => $solicitud->id]) }}" wire:navigate>
