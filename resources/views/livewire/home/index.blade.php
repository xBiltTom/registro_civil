                ...
                <div class="bg-gray-800 border-l-8 border-blue-500 rounded-lg shadow">
                    <div class="px-7 py-9">
                        <div class="flex items-center">
                            <svg class="w-16 h-16 text-blue-400" xmlns="http://www.w3.org/2000/svg" fill="none"
                    ...
                    <div class="px-7 py-9">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                class="w-16 h-16 text-yellow-300">
                ...
                <div class="bg-gray-800 border-l-8 border-indigo-500 rounded-lg shadow">
                    <div class="px-7 py-9">
                        <div class="flex items-center">
                            ...
                            <h3 class="ml-4 text-6xl font-bold text-white">{{ $usuarios }}</h3>
                        </div>
                        <p class="mt-4 text-sm text-indigo-300">Usuarios registrados</p>
                    </div>
                </div>
                {{-- Panel de Administración --}}
                <a href="{{ url('admin') }}" class="block bg-gray-800 hover:bg-gray-700 border-l-8 border-purple-600 rounded-lg shadow transition duration-300">
                    <div class="px-7 py-6 flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-2xl font-bold text-white">Administración</h3>
