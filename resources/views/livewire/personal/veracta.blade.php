                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex">
                            <input
                                ...
                                value="{{ $acta->actaNacimiento->nacido->lugar->distrito ?? 'N/A' }}, {{ $acta->actaNacimiento->nacido->lugar->provincia ?? 'N/A' }}, {{ $acta->actaNacimiento->nacido->lugar->departamento ?? 'N/A' }}"
                                id="lugar_nacimiento"
                                class="flex-1 bg-gray-800 rounded-l-md border-gray-700 text-white px-3 py-2"
                                type="text"
                                readonly>
