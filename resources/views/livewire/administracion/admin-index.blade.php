...
>
    ...
    <div class="flex flex-wrap justify-center bg-gray-700 gap-4">
        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <div class="w-full h-48">
                    <img class="rounded-t-lg w-full h-full object-contain" src="{{asset('img/logoUsuario.png')}}" alt="" />
                </div>
            </a>
            <div class="p-5">
        ...
        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <div class="w-full h-48">
                    <img class="rounded-t-lg w-full h-full object-contain" src="{{asset('img/logoRol.png')}}" alt="" />
                </div>
            </a>
            <div class="p-5">
