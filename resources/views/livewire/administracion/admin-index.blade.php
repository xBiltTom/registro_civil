        ...
        x-on:open-modal.window="showModal = true; loadFlowbite()" x-on:close-modal.window="showModal = false">
            <div x-show="showModal" class="fixed top-0 left-0 right-0 z-50 flex items-center justify-center w-full h-full bg-gray-900 bg-opacity-50" style="display: none;">
                ...
                <div  class="col-span-2">
                    ...
                    <div class="flex justify-center">
                        <button x-on:click="$dispatch('close-declarante-modal')"  type="submit" class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
