        ...
        x-on:open-modal.window="showModal = true; loadFlowbite()" x-on:close-modal.window="showModal = false">
            <div x-show="showModal" class="fixed top-0 left-0 right-0 z-50 flex items-center justify-center w-full h-full bg-gray-900 bg-opacity-50" style="display: none;">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 w-96">
                    ...
                    <div class="col-span-2 ">
                        <label for="persona" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Persona: </label>
                        ...
                        {{-- <form>
                            ...
                            <input wire:input="buscar($event.target.value)"  type="search" id="search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search" required />
                        ...
                        <div class="flex justify-center w-full">
                            <button
                                x-on:click="() => { $dispatch('open-declarante-modal'); $dispatch('close-modal'); }"
                                        ...
                                        <template x-for="persona in personasPaginadas" :key="persona.id">
                                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                ...
                                                <td class="px-6 py-4 text-right">
                                                    <button @click="()=> {$dispatch('close-declarante-modal');$dispatch('open-modal');}" type="button" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md">
                                                        Seleccionar
                                                    </button>
                                                </td>
                                            </tr>
